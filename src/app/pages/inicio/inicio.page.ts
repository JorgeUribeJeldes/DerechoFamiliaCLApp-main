...
import {
  ...
  IonCardTitle, IonCardContent, IonButton, IonMenuButton, IonButtons,
  IonList, IonItem, IonIcon, IonCardSubtitle, IonGrid, IonRow, IonCol,
  IonSpinner, IonBadge, IonText, IonSearchbar, IonLabel, IonNote,
